...
///////EDIT STARTS HERE/////////////////
            if (character <= 1) {
                ...
                System.out.print("\n    Please pick U or D or B (for both Up and Down): ");
            }
            do {
                contUD = 1;
                if (character <= 1) {
                    ...
                    else if (doYouWant == 'B' || doYouWant =='b') {
                        contUD = 0;
                    }
                    else {
                        contUD = 1;
...
///////FOR BOTH/////
            if (doYouWant == 'B' || doYouWant =='b')
            {
                BothcheckUpOrDown = elevatorStatus(character,elevator1,elevator2, doYouWant);

                if (BothcheckUpOrDown == 1)//BOTH GOING DOWN
                {
                    LeftUpDown = "\\/";
                    RightUpDown = "\\/";
                    ...
                    {
                        elevator1 = y;
                        for (int x = elevator2; x>=character ;x--)
                        {
                            elevator2 = x;
                        }
                        deleteLine(9);
                        topdesignBoth(elevator1, elevator2, character, LeftUpDown, RightUpDown);
                        elevIdle(topS,midS,botS);
                        delay(2000);
                        deleteLine(9);
                    }
                    //OPENING BOTH
                    topdesignBoth(elevator1, elevator2, character, "  ", "  ");
                    BothOpening();
                    BothClosing();
                    
                }
                else if (BothcheckUpOrDown == 2)//LEFT GOING DOWN, RIGHT GOING UP
                {
                    LeftUpDown = "\\/";
                    RightUpDown = "/\\";
                    for (int y = elevator1; y >=character;y--)
                ...
                else if (BothcheckUpOrDown == 3)//LEFT GOING DOWN, RIGHT CONSTANT
                {
                    LeftUpDown = "\\/";
                    RightUpDown = "  ";
                    for (int y = elevator1; y >=character;y--)
                ...
                else if (BothcheckUpOrDown == 4)//LEFT GOING UP, RIGHT GOING DOWN
                {
                    LeftUpDown = "/\\";
                    RightUpDown = "\\/";
                    for (int y = elevator1; y <=character;y++)
                ...
                else if (BothcheckUpOrDown == 5)//BOTH UP
                {
                    LeftUpDown = "/\\";
                    RightUpDown = "/\\";
                    for (int y = elevator1; y <=character;y++)
                ...
                else if (BothcheckUpOrDown == 6)//LEFT GOING UP, RIGHT CONSTANT
                {
                    LeftUpDown = "/\\";
                    RightUpDown = "  ";
                    for (int y = elevator1; y <=character;y++)
                ...
                else if (BothcheckUpOrDown == 7)//LEFT CONSTANT, RIGHT GOING DOWN
                {
                    LeftUpDown = "  ";
                    RightUpDown = "\\/";
                ...
                else if (BothcheckUpOrDown == 8)//LEFT CONSTANT, RIGHT GOING UP
                {
                    LeftUpDown = "  ";
                    RightUpDown = "/\\";
                    for (int x = elevator2; x<=character ;x++)
                ...
                else if (BothcheckUpOrDown == 9)//BOTH CONSTANT
                {
    ...
    /////FOR UP OR DOWN//////
            else if (doYouWant == 'D' || doYouWant =='d' || doYouWant == 'U' || doYouWant =='u')
            {
...
public static void elevIdle(char x, char y, char z)
    ...
    public static void elevIdle(String x, String y, String z)
    { 
        //x = top, y = mid, z= bot
        System.out.println("    |  _______________       _______________  |");
        System.out.println("    |  |      |      |  "+x+"   |      |      |  |");
...
public static void BothOpening()
{
    System.out.println("    |  _______________       _______________  |");
    System.out.println("    |  |      |      |       |      |      |  |");
    System.out.println("    |  |      |      |       |      |      |  |");
    ...
    System.out.println("    |  |    |   |    |       |    |   |    |  |");
    System.out.println("    |  |    |   |    |       |    |   |    |  |");
    System.out.println("    |__|____|___|____|_______|____|___|____|__|");
    delay(2000);
    deleteLine(5);
    System.out.println("    |  _______________       _______________  |");
    System.out.println("    |  | |         | |       | |         | |  |");
    System.out.println("    |  | |         | |       | |         | |  |");
    System.out.println("    |  | |         | |       | |         | |  |");
    System.out.println("    |__|_|_________|_|_______|_|_________|_|__|");
    delay(2000);
    deleteLine(5);
}
public static void BothClosing()
{
    System.out.println("    | _____________          _______________  |");
    System.out.println("    | |    O    | |          | |    O    | |  |");
    System.out.println("    | |   /|\\   | |          | |   /|\\   | |  |");
    System.out.println("    | |    |    | |          | |    |    | |  |");
    System.out.println("    |_|___/_\\___|_|__________|_|___/_\\___|_|__|");
    delay(2000);
    deleteLine(5);
    System.out.println("    |  _______________       _______________  |");
    System.out.println("    |  |    | O |    |       |    | O |    |  |");
    System.out.println("    |  |    |/|\\|    |       |    |/|\\|    |  |");
    System.out.println("    |  |    | | |    |       |    | | |    |  |");
    System.out.println("    |__|____|/_\\|____|_______|____|/_\\|____|__|");
    delay(2000);
    deleteLine(5);
    System.out.println("    |  _______________       _______________  |");
    System.out.println("    |  |      |      |       |      |      |  |");
